...
public class InstrumentGUIBox {
    ...
    //constructor for the theremin
    @SuppressLint("ResourceType")
    public InstrumentGUIBox(Lobby lobby, int overload){
        textInCenter = null;
        image4Theremin = (ImageView) lobby.findViewById(R.drawable.theremin);
        defaultBlack = (ImageView) lobby.findViewById(R.drawable.black);

        image4Theremin.setVisibility(View.VISIBLE);

    }

    //constructor for the drums
    @SuppressLint("ResourceType")
    public InstrumentGUIBox(Lobby lobby) {
        textInCenter = null;

        //image4Drums.setImageResource(R.drawable.drums0);
        image4Drums = (ImageView) lobby.findViewById(R.drawable.drums0);
