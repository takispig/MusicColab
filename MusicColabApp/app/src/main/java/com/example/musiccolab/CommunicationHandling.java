...
class RegisterThread extends Thread{
    @Override
    public void run() {
        CommunicationHandling.getInstance().register(CommunicationHandling.email,CommunicationHandling.userName,CommunicationHandling.password, CommunicationHandling.question); //VH - 22.06
    }
}
...
public class CommunicationHandling {
    ...
    public static String question; //VH - 22.06
    ...
    public void register(String email, String userName, String password, String question){
        action = 3;
        if(loginSystem(action, email, userName, password, question).equals("Error")){
    ...
    public void login(String userName, String password){
        action = 1;
        if(loginSystem(action, "", userName, password, null).equals("Error")){
            toast("Login Failed\nPlease try again");
        }
    }
...
//______________________________________________________________________________________________________________________
    private String loginSystem(short action, String email, String userName, String password, String question){ //VH - 22.06
        String response;
        ByteBuffer buffer = null;
