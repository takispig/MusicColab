...
class MusicJoinerTest {
    ...
    void handleToneData() throws IOException {
        ...
        assertEquals(0, MusicJoiner.handleToneData(messageCharset, lobby, toneAction, toneType, toneData, admin, action));

        // Test mit lobby = null
        assertEquals(-1, MusicJoiner.handleToneData(messageCharset, null, toneAction, toneType, toneData, admin, action));
